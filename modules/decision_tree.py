...
def decision_tree_module(df):
    ...
    # --- AJUSTE 1: Configuración de hiperparámetros según selección ---
...
def display_classification_results(y_test, y_pred, y_prob, classes, use_regression_model):
    ...
    # --- AJUSTE 2: Mostrar curvas ROC solo para clasificación (no regresión) ---
    ...
    # --- AJUSTE 2: Curvas ROC solo para clasificación (no regresión) y con soporte multiclase ---
    if not use_regression_model and y_prob is not None:
        if is_binary_classification:
            with tab3:
